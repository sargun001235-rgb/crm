...
export default function EditPrescriptionClient({ customers, prescription }: { customers: any[], prescription: any }) {
  ...
  const form = useForm({
    defaultValues: {
      ...
      re_sph: prescription.re_sph !== null ? formatPower(prescription.re_sph) : "", 
      re_cyl: prescription.re_cyl !== null ? formatPower(prescription.re_cyl) : "", 
      re_axis: prescription.re_axis?.toString() || "", 
      re_add: prescription.re_add !== null ? formatPower(prescription.re_add) : "", 
      re_prism: prescription.re_prism || "", 
      re_va: prescription.re_va || "",
      le_sph: prescription.le_sph !== null ? formatPower(prescription.le_sph) : "", 
      le_cyl: prescription.le_cyl !== null ? formatPower(prescription.le_cyl) : "", 
      le_axis: prescription.le_axis?.toString() || "", 
      le_add: prescription.le_add !== null ? formatPower(prescription.le_add) : "", 
      le_prism: prescription.le_prism || "", 
      le_va: prescription.le_va || "",
      pd: prescription.pd || "", 
      lensType: prescription.lens_type ? prescription.lens_type.split(",").map((s: string) => s.trim()) : [] as string[], 
      frameType: prescription.frame_type || "", 
      lensCoating: prescription.lens_coating ? prescription.lens_coating.split(",").map((s: string) => s.trim()) : [] as string[], 
