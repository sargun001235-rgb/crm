...
export default function EditPrescriptionClient({ customers, prescription }: { customers: any[], prescription: any }) {
  ...
  const form = useForm({
    defaultValues: {
      ...
      re_sph: prescription.re_sph?.toString() || "", re_cyl: prescription.re_cyl?.toString() || "", re_axis: prescription.re_axis?.toString() || "", re_add: prescription.re_add?.toString() || "", re_prism: prescription.re_prism || "", re_va: prescription.re_va || "",
      le_sph: prescription.le_sph?.toString() || "", le_cyl: prescription.le_cyl?.toString() || "", le_axis: prescription.le_axis?.toString() || "", le_add: prescription.le_add?.toString() || "", le_prism: prescription.le_prism || "", le_va: prescription.le_va || "",
      pd: prescription.pd || "", 
